    ...
    def parse(self, response):
        for quote in response.xpath("descendant-or-self::div[@class and contains(concat(' ', normalize-space(@class), ' '), ' quote ')]"):
            yield { 
                ...
                'author': quote.xpath("descendant-or-self::small[@class and contains(concat(' ', normalize-space(@class), ' '), ' author ')]/text()").get(),
        ...
        next_page = response.xpath("descendant-or-self::li[@class and contains(concat(' ', normalize-space(@class), ' '), ' next ')]/descendant-or-self::*/a/@href").get()
